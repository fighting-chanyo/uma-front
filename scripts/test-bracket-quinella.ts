...
// 2. Box
// Current implementation in betting-utils.ts uses (count * (count + 1)) / 2
// For 2 selections (1, 2), it returns 3 (1-1, 1-2, 2-2).
runTest('Box 1,2 (Current Logic)', 'BRACKET_QUINELLA', 'BOX', [['1', '2']], [], [], 3); 
